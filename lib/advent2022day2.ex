defmodule Advent2022Day2 do
  def day2() do
    ...
    totals =
      for {choice_score, play_score} <- Enum.zip(score_choices(plays), score_plays(plays)),
          do: choice_score + play_score
    ...
    predicted_totals =
      for {choice_score, play_score} <-
            Enum.zip(score_choices(predicted_plays), score_plays(predicted_plays)),
          do: choice_score + play_score
  ...
  defp score_play({theirs, mine})
       ...
       when theirs == "C" and mine == "Y" do
    0
  end

  def pick_plays(predicted_list) do
  ...
  defp pick_play({theirs, outcome})
       ...
       when outcome == "Z" and theirs == "C" do
    {theirs, "X"}
  end
  ...
  defp pick_play({theirs, outcome})
       ...
       when outcome == "Z" and theirs == "A" do
    {theirs, "Y"}
  end
  ...
  defp pick_play({theirs, outcome})
       ...
       when outcome == "Z" and theirs == "B" do
    {theirs, "Z"}
  end
end
