defmodule AdventDay6 do
  ...
  @spec process_bytestream(list(integer()), integer(), tuple(), integer(), integer(), String.t()) ::
          integer()
  ...
  @spec initialize(integer(), list(integer()), tuple(), integer(), String.t()) ::
          {list(integer()), tuple(), integer()}
  ...
  @spec initialize_som(integer(), list(integer()), tuple(), integer(), String.t()) ::
          {list(integer()), tuple(), integer()}
